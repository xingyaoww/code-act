# Borrowed from: https://huggingface.co/spaces/codeparrot/apps_metric/blob/main/testing_util.py
...
def call_method(method, inputs):
    ...
    def mock_input_fn(*args):
        try:
            return next(inputs_line_iterator)
        except StopIteration:
            while True:
                pass  # Infinite loop to mimic hanging behavior

    # sys.setrecursionlimit(10000)
    # @patch('builtins.input', side_effect=inputs.split("\n"))
    @patch('builtins.open', mock_open(read_data=inputs))
    @patch('builtins.input', mock_input_fn)
